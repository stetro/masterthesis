...
\begin{lstlisting}[caption=Chisel TSDF Pseudocode Algorithmus, label=lst:chisel]
...
Neben space carving wurden zudem dynamische Strahlenbegrenzungen und Gewichtungen der Voxel abhänig von der jeweils aufgenommenen Tiefe eingebunden. Diese Eigenschaft berücksichtigt die Verteilung von Messungenauigkeiten des Sensors, die bei größerer Entfernung zur Kamera zunehmen können. \citep{Klingensmith_2015_7924}